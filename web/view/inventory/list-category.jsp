                        ...
                        <div class="col l-10">
                            ...
                            <table class="content__list-category-table">
                                <tr class="content__list-category-row">
                                    <td colspan="5" class="content__list-category-col">
                                        <a class="content__list-category-link" href="category/create"
                                ...
                                <c:forEach items="${requestScope.categories}" var="category">
                                    <tr class="content__list-category-row">
                                        ...
                                        <td class="content__list-category-col">
                                            <span class="content__list-category-link ${category.active?"":"content__list-category-link--disable"}" 
                                        ...
                                        <td class="content__list-category-col">
                                            ...
                                            <c:if test="${category.used}">
                                                <a class="button--small button--transparent ${category.active?"":"button--disable"}" 
                                                   onclick="passToInactive(${category.id})" 
                                            ...
                                            <c:if test="${not category.used}">
                                                <a class="button--small button--transparent"
                                                   onclick="passToDelete(${category.id})" 
                        ...
                        <div class="modal-body">
                            <table class="table table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Description: </td>
                                        <td><input type="text" name="insertDesc"/></td>
                                    </tr>
                                    <tr>
                                        <td>Status: </td>
                                        <td>
                                            <input type="checkbox" name="insertStatus"/>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="updateID" id="updateIDSent"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Name: </td>
                                    ...
                                    <tr>
                                        <td>Description: </td>
                                        <td><input type="text" name="updateDesc" id="updateDesc"/></td>
                                    </tr>
                                    <tr>
                                        <td>Status: </td>
                                        <td>
                                            <input type="checkbox" name="updateStatus" id="updateStatus"/>
                                            <label for="updateStatus">Active</label>
                                        </td>
                                    </tr>
                                </tbody>
