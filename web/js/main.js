...
function createPaggerInout(div, pageIndex, gap, totalPages) {
    var container = document.getElementById(div);
    var prevPage = pageIndex - 1;
    var nextPage = pageIndex + 1;
    if (container != null) {
        container.innerHTML += "<a id='firstPagger' class='pagger__link' href='report/inout?page=1'><span class='material-icons'>first_page</span></a>";
        container.innerHTML += "<a id='prevPagger' class='pagger__link' href='report/inout?page=" + prevPage + "'><span class='material-icons'>chevron_left</span></a>";
        if (pageIndex <= 1) {
//            document.getElementById("firstPagger").classList.add("pagger__link--disable");
            document.getElementById("firstPagger").removeAttribute("href");
//            document.getElementById("prevPagger").classList.add("pagger__link--disable");
        ...
        for (var i = pageIndex - gap; i < pageIndex; i++) {
            if (i > 0) {
                container.innerHTML += "<a class='pagger__link' href='report/inout?page=" + i + "'>" + i + "</a>";
            }
        }
        container.innerHTML += "<a class='pagger__link pagger__link--active'>" + pageIndex + "</a>";
        for (var i = pageIndex + 1; i <= pageIndex + gap; i++) {
        ...
        container.innerHTML += "<a id='nextPagger' class='pagger__link' href='report/inout?page=" + nextPage + "'><span class='material-icons'>chevron_right</span></i></a>";
        container.innerHTML += "<a id='lastPagger' class='pagger__link' href='report/inout?page=" + totalPages + "'><span class='material-icons'>last_page</span></i></a>";
        if (pageIndex >= totalPages) {
//            document.getElementById("nextPagger").classList.add("pagger__link--disable");
            document.getElementById("nextPagger").removeAttribute("href");
//            document.getElementById("lastPagger").classList.add("pagger__link--disable");
...
function createPaggerExpReport(div, pageIndex, gap, totalPages) {
    var container = document.getElementById(div);
    var prevPage = pageIndex - 1;
    var nextPage = pageIndex + 1;
    if (container != null) {
        container.innerHTML += "<a id='firstPagger' class='pagger__link' href='report/expiration?page=1'><span class='material-icons'>first_page</span></a>";
        container.innerHTML += "<a id='prevPagger' class='pagger__link' href='report/expiration?page=" + prevPage + "'><span class='material-icons'>chevron_left</span></a>";
        if (pageIndex <= 1) {
//            document.getElementById("firstPagger").classList.add("pagger__link--disable");
            document.getElementById("firstPagger").removeAttribute("href");
//            document.getElementById("prevPagger").classList.add("pagger__link--disable");
        ...
        for (var i = pageIndex - gap; i < pageIndex; i++) {
            if (i > 0) {
                container.innerHTML += "<a class='pagger__link' href='report/expiration?page=" + i + "'>" + i + "</a>";
            }
        }
        container.innerHTML += "<a class='pagger__link pagger__link--active'>" + pageIndex + "</a>";
        for (var i = pageIndex + 1; i <= pageIndex + gap; i++) {
        ...
        container.innerHTML += "<a id='nextPagger' class='pagger__link' href='report/expiration?page=" + nextPage + "'><span class='material-icons'>chevron_right</span></i></a>";
        container.innerHTML += "<a id='lastPagger' class='pagger__link' href='report/expiration?page=" + totalPages + "'><span class='material-icons'>last_page</span></i></a>";
        if (pageIndex >= totalPages) {
//            document.getElementById("nextPagger").classList.add("pagger__link--disable");
            document.getElementById("nextPagger").removeAttribute("href");
//            document.getElementById("lastPagger").classList.add("pagger__link--disable");
...
function createPaggerOutStock(div, pageIndex, gap, totalPages) {
    var container = document.getElementById(div);
    var prevPage = pageIndex - 1;
    var nextPage = pageIndex + 1;
    if (container != null) {
        container.innerHTML += "<a id='firstPagger' class='pagger__link' href='report/outstock?page=1'><span class='material-icons'>first_page</span></a>";
        container.innerHTML += "<a id='prevPagger' class='pagger__link' href='report/outstock?page=" + prevPage + "'><span class='material-icons'>chevron_left</span></a>";
        if (pageIndex <= 1) {
//            document.getElementById("firstPagger").classList.add("pagger__link--disable");
            document.getElementById("firstPagger").removeAttribute("href");
//            document.getElementById("prevPagger").classList.add("pagger__link--disable");
        ...
        for (var i = pageIndex - gap; i < pageIndex; i++) {
            if (i > 0) {
                container.innerHTML += "<a class='pagger__link' href='report/outstock?page=" + i + "'>" + i + "</a>";
            }
        }
        container.innerHTML += "<a class='pagger__link pagger__link--active'>" + pageIndex + "</a>";
        for (var i = pageIndex + 1; i <= pageIndex + gap; i++) {
        ...
        container.innerHTML += "<a id='nextPagger' class='pagger__link' href='report/outstock?page=" + nextPage + "'><span class='material-icons'>chevron_right</span></i></a>";
        container.innerHTML += "<a id='lastPagger' class='pagger__link' href='report/outstock?page=" + totalPages + "'><span class='material-icons'>last_page</span></i></a>";
        if (pageIndex >= totalPages) {
//            document.getElementById("nextPagger").classList.add("pagger__link--disable");
            document.getElementById("nextPagger").removeAttribute("href");
//            document.getElementById("lastPagger").classList.add("pagger__link--disable");
